...
PAGE_NUMBER = 2
NEXT_PAGE_NAME = 'Conversational_Thread_3'
PREV_PAGE_NAME = 'Conversational_Thread_1'
PAGE_TITLE = 'Annotation Phase: Conversational Thread 2'
EXPORT_FILE_NAME = '_conversational_thread_2.txt'
NEXT_BUTTON = 'Socratic Thread 3 >'
PREV_BUTTON = '< Socratic Thread 1'
...
def run_interface_ide():
    ...
    with c3:
        ...
        if next_button:
            #TODO: Add a pop up to confirm save or not
            st.session_state.load_page_from_exported_memory = True
            st.session_state.is_exported = False
