...
PAGE_NUMBER = 0
NEXT_PAGE_NAME = 'Conversational_Thread_1'
PREV_PAGE_NAME = 'Browse_Bugs'
PAGE_TITLE = 'Annotation Phase: Initial Socratic Dialogue'
EXPORT_FILE_NAME = '_socratic_dialogue.txt'
NEXT_BUTTON = 'Socratic Thread 1 >'
PREV_BUTTON = '< Browse Bugs'
